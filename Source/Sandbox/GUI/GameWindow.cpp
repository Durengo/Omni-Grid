...
namespace Sandbox{
    ...
    void GameWindow<T>::Start() {
        ...
        InitWindow(m_Game.m_guiInfo->width, m_Game.m_guiInfo->height, m_Game.m_guiInfo->m_windowName.c_str());
    ...
    void GameWindow<T>::PreRun() {
        ...
        gameOverText("Game Over!", 20, 0, 100, BLACK, OGRID::Justify::CENTER_X, m_Game.m_guiInfo->width, m_Game.m_guiInfo->height);

        winnerText("Winner: ", 20, 0, 150, BLACK, OGRID::Justify::CENTER_X, m_Game.m_guiInfo->width, m_Game.m_guiInfo->height);

        currentPlayerText("Current Player: ", 8, 5, 5, BLACK, OGRID::Justify::NONE, m_Game.m_guiInfo->width, m_Game.m_guiInfo->height);
        turnText("Turn: ", 8, 5, 20, BLACK, OGRID::Justify::NONE, m_Game.m_guiInfo->width, m_Game.m_guiInfo->height);

        drawText("Draw!", 20, 0, 100, BLACK, OGRID::Justify::CENTER_X, m_Game.m_guiInfo->width, m_Game.m_guiInfo->height);
    }
    ...
    Vector2 GameWindow<T>::GetCellFromMouse(Vector2 mousePosition) {
        ...
        float gridStartY = (m_Game.m_guiInfo.windowResolution.height - (m_Game.m_guiInfo.cellSize * m_Game.m_guiInfo.gridSize)) / 2.0f;
