...
namespace OGRIDSandbox
{
    ...
    OGRID::GameLogic *GUI::i_gameLogic;
    ...
    GUI::GUI()
    {
        ...
        i_instance->i_gameLogic = OGRID::GameLogic::GetInstance();
    }
    ...
    GUI::~GUI()
    {
        if (i_instance->i_gameLogic != nullptr)
        {
            ...
            OGRID::GameLogic::DeleteInstance();
        }
    }
    ...
    OGRID::GameLogic *GUI::GetGameLogic()
    {
        DEBUG_ASSERT(i_instance, "GUI instance not initialized.");
    ...
    void GUI::SetGameConfiguration(OGRID::GameConfiguration *gameConfiguration)
    {
        DEBUG_ASSERT(i_instance, "GUI instance not initialized.");
    ...
    void GUI::DrawGrid()
    {
        ...
        for (int i = 0; i < i_instance->m_gridSize; i++)
        {
            ...
            {
                if (i_instance->i_gameLogic->GetGrid()->GetCharAt(i, j) == OGRID::MoveTypeEnumToChar(OGRID::MoveType::X))
                {
                    i_instance->DrawX(i, j);
                }
                else if (i_instance->i_gameLogic->GetGrid()->GetCharAt(i, j) == OGRID::MoveTypeEnumToChar(OGRID::MoveType::O))
                {
    ...
    void GUI::ChangeTurnOrder()
    {
        ...
        if (choice == 1)
        {
            ...
            {
                i_instance->i_gameLogic->GetPlayers()[0]->SetPlayerMoveType(OGRID::MoveType::X);
                i_instance->i_gameLogic->GetPlayers()[1]->SetPlayerMoveType(OGRID::MoveType::O);
            }
            else
            {
                i_instance->i_gameLogic->GetPlayers()[0]->SetPlayerMoveType(OGRID::MoveType::O);
                i_instance->i_gameLogic->GetPlayers()[1]->SetPlayerMoveType(OGRID::MoveType::X);
        ...
        else if (choice == 2)
        {
            ...
            // OGRID::Player *temp = i_instance->i_gameLogic->GetPlayers()[1];
    ...
    void GUI::BeginMainLoop()
    {
        ...
        OGRID::Button restartButton(
            ...
            GRAY, DARKGRAY, LIGHTGRAY, []()
            {
                ...
                i_instance->i_gameLogic->SetGameState(OGRID::GameState::InProgress); },
            "Restart", false);
        ...
        OGRID::Text gameOverText("Game Over!", 20, 0, 100, BLACK, OGRID::Justify::CENTER_X, i_instance->m_windowResolution.width, i_instance->m_windowResolution.height);

        OGRID::Text winnerText("Winner: ", 20, 0, 150, BLACK, OGRID::Justify::CENTER_X, i_instance->m_windowResolution.width, i_instance->m_windowResolution.height);

        OGRID::Text currentPlayerText("Current Player: ", 8, 5, 5, BLACK, OGRID::Justify::NONE, i_instance->m_windowResolution.width, i_instance->m_windowResolution.height);
        OGRID::Text turnText("Turn: ", 8, 5, 20, BLACK, OGRID::Justify::NONE, i_instance->m_windowResolution.width, i_instance->m_windowResolution.height);

        OGRID::Text drawText("Draw!", 20, 0, 100, BLACK, OGRID::Justify::CENTER_X, i_instance->m_windowResolution.width, i_instance->m_windowResolution.height);
        ...
        while (!WindowShouldClose()) // Detect window close button or ESC key
        {
            ...
            // Update
            if (IsMouseButtonPressed(MOUSE_LEFT_BUTTON) && i_instance->i_gameLogic->GetGameState() != OGRID::GameState::GameOver)
            {
            ...
            if (i_instance->i_gameLogic->GetGameState() == OGRID::GameState::InProgress)
            {
                ...
                turnText.SetText("Turn: " + OGRID::MoveTypeEnumToString(i_instance->i_gameLogic->GetGameConfiguration()->turnManager->GetCurrentPlayer().ptr->GetPlayerMoveType()));
                currentPlayerText.Draw();
                turnText.Draw();
            }
            else if (i_instance->i_gameLogic->GetGameState() == OGRID::GameState::GameOver)
            {
                if (i_instance->i_gameLogic->GetGameOverType() == OGRID::GameOverType::Win)
                {
                    restartButton.isEnabled = true;
                    changeGridButton.isEnabled = true;
                    // changeTurnOrderButton.isEnabled = true;

                    winnerText.SetText("Winner: " + i_instance->i_gameLogic->GetWinner()->GetPlayerName() + " (" + OGRID::MoveTypeEnumToString(i_instance->i_gameLogic->GetWinner()->GetPlayerMoveType()) + ")");
                    gameOverText.Draw();
                    winnerText.Draw();
                    restartButton.Draw();
                ...
                else if (i_instance->i_gameLogic->GetGameOverType() == OGRID::GameOverType::Draw)
                {
                    restartButton.isEnabled = true;
                    changeGridButton.isEnabled = true;
                    // changeTurnOrderButton.isEnabled = true;
